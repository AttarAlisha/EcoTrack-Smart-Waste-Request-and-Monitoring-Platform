...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost/waste-management-system/index.html">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <!-- <li>
                    <a href="http://localhost/waste-management-system/index.html" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-search"></i><mark> Dashboard</mark> <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                   
                </li> -->

                <li>
                    <a href="http://localhost/waste-management-system/index.html" ><i class="ffa fa-fw fa-paper-plane-o"></i> Dashboard </a>
                ...
                <li>
                    <a href="http://localhost/waste-management-system/index.html"><i class="fa fa-fw fa fa-question-circle"></i> Logout</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
...
function confirmDelete(){
    window.location.replace("http://localhost/waste-management-system/adminlogin/admindelete.php?i="+delId);
}
</script>
</body>
</html>