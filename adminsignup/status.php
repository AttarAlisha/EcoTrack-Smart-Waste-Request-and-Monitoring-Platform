  ...
  $Id= $_POST['id'];
   $status = $_POST['status'];
    ...
    if($data) {
       ...
       header("Location: http://localhost/waste-management-system/adminsignup/index.php", TRUE, 301);
       exit();
        ...
        <div class="form-group">
                    ...
                    <!-- <select class="form-control" id="status" name="status" value ="<?php echo "$s"; ?>"required >
					   ...
					   <select class="form-control" id="status" name="status" required>
    							...
    							<option value="Invalid" <?php echo ($s == 'Invalid') ? 'selected' : ''; ?>>Please do a valid complaint</option>
						</select>
