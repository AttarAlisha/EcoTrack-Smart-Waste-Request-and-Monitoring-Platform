	...
	if( in_array($imageFileType,$extensions_arr) ){
	   ...
	   move_uploaded_file($image = $_FILES['file']['tmp_name'],$target_dir.$file);
    	...
    	if(mysqli_query($con,$sql)){
			$msg = '<div class = "alert alert-success"><span class="fa fa-check"> "Complain Registered Successfully!"</span><a href="http://localhost/waste-management-system/adminlogin/welcome.php"> view Complain </a></div>';
...
<body>
	<div>
        <a href="http://localhost/waste-management-system/index.html"  class="fa fa-home"> Home </a>
    </div>
